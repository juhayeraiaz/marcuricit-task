            ...
            <div className="">
                <div className="row gy-5">
                    <div className="col-md-8">
                        <div className="p-5 rounded-3 bg-white border border-gray-200 shadow-sm">
                            <svg
                                className="mx-auto d-block w-50 opacity-75"
                                viewBox="0 0 146 146"
                                fill="none"
                            ...
                            <div>
                                ...
                                <div className="mt-2 d-flex justify-content-center gap-4">
                                    ...
                                    <div className="d-flex align-items-end gap-1 text-green-500">
                                        <svg
                                            className="w-3"
                                            viewBox="0 0 12 15"
                                            fill="none"
                                ...
                                <span className="d-block text-center text-gray-500">Compared to last week $13,988</span>
                            </div>
                            <table className="w-100 text-gray-600 mt-4">
                                <tbody>
                                    <tr>
                    ...
                    <div className="col-md-4">
                        <div className="p-5 rounded-3 bg-white border border-gray-200 shadow-sm h-100">
                            ...
                            <div className="border-0">
                                <div className="p-5 h-100">
                                    <svg
                                        className="mx-auto d-block w-40"
                                        viewBox="0 0 56 56"
                                        fill="none"
                                        xmlns="http://www.w3.org/2000/svg"
                                    >
                                    ...
                                    <div className="mt-6">
                                        <h5 className="text-center text-xl text-gray-700">Ask to customize</h5>
                                    ...
                                    <table className="mt-6 mb-2 w-100 text-gray-600">
                                        <tbody>
                                            <tr>
                                                <td className="py-2">Tailored ui</td>
                                                <td className="text-gray-500">896</td>
