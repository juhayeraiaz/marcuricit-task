    ...
    return (
        <div>
            <body class="bg-gray-100 dark:bg-gray-900">
                {visible ? <aside
                    class="fixed top-0 z-10 ml-[-100%] flex h-screen w-full flex-col justify-between border-r bg-white px-6 pb-3 duration-300 md:w-4/12 lg:ml-0 lg:w-[25%] xl:w-[20%] 2xl:w-[15%] dark:bg-gray-800 dark:border-gray-700 ease-in sidebar overflow-x-hidden"
                >
                    <div className=''>
                        ...
                        <div class="mt-8 text-center">
                            <img
                                ...
                                alt=""
                                class="m-auto h-10 w-10 rounded-full object-cover"
                            />
                        ...
                        <ul class="mt-8 space-y-2 tracking-wide">
                            ...
                            <li>
                                <a href="/#" class="group flex items-center space-x-4 rounded-md px-4 py-3 text-gray-600 justify-normal dark:text-gray-300 active" id="profile">
                            ...
                            <li>
                                <a href="/#" class="group flex items-center space-x-4 rounded-md px-4 py-3 text-gray-600 justify-normal dark:text-gray-300" id="groups">
                            ...
                            <li>
                                <a href="/#" class="group flex items-center space-x-4 rounded-md px-4 py-3 text-gray-600 justify-normal dark:text-gray-300" id="reports">
                            ...
                            <li>
                                <a href="/#" class="group flex items-center space-x-4 rounded-md px-4 py-3 text-gray-600 justify-normal dark:text-gray-300" id="branches">
                            ...
                            <li>
                                <a href="/#" class="group flex items-center space-x-4 rounded-md px-4 py-3 text-gray-600 justify-normal dark:text-gray-300" id="tests">
                            ...
                            <li>
                                <a href="/#" class="group flex items-center space-x-4 rounded-md px-4 py-3 text-gray-600 justify-normal dark:text-gray-300" id="cultures">
                            ...
                            <li>
                                <a href="/#" class="group flex items-center space-x-4 rounded-md px-4 py-3 text-gray-600 justify-normal dark:text-gray-300" id="culture_options">
                                    <i class=" fas fa-vial"></i>
                                    <p className='group-hover:text-gray-700 dark:group-hover:text-gray-50'>
                                        Culture options
                                    </p>
                            ...
                            <li>
                                <a href="/#" class="group flex items-center space-x-4 rounded-md px-4 py-3 text-gray-600 justify-normal dark:text-gray-300" id="antibiotics">
                            ...
                            <li>
                                <a href="/#" class="group flex items-center space-x-4 rounded-md px-4 py-3 text-gray-600 justify-normal dark:text-gray-300" id="doctors">
                            ...
                            <li className="relative" id="prices">
                                ...
                                >
                                    ...
                                    <span className="flex items-center">
                                        <p>Price List</p>
                                        <i
                                            className={`right fas fa-angle-down transition-transform duration-200 ${isDropdownOpen ? 'rotate-180' : ''
                                                }`}
                                        ></i>
                                    </span>
                                </a>
                    ...
                    {user ?
                        <div class="-mx-6 flex items-center justify-between border-t px-6 pt-4 dark:border-gray-700">
                            <button class="group flex items-center space-x-4 rounded-md px-4 py-3 text-gray-600 dark:text-gray-300">
                                ...
                                <span class="group-hover:text-gray-700 dark:group-hover:text-white" onClick={logout}>Logout</span>
                            </button>
                        </div> : <></>}
                </aside> : <aside
                    class="fixed top-0 z-10 ml-[-100%] flex h-screen w-full flex-col justify-between border-r bg-white px-6 pb-3 duration-300 md:w-4/12 lg:ml-0 lg:w-[15%] xl:w-[10%] 2xl:w-[5%] dark:bg-gray-800 dark:border-gray-700 ease-in"
                >
                    <div>
                        <div class="-mx-6 px-6 py-4">
                            <a href="/#" title="home">
                        ...
                        <div class="mt-8 text-center">
                            <img
                                ...
                                class="m-auto h-10 w-10 rounded-full object-cover"
                            />
                            <h5 class="mt-4 hidden text-sm font-semibold text-gray-600 lg:block dark:text-gray-300">Cynthia J. Watts</h5>
                        </div>
                        ...
                        <ul class="mt-8 space-y-2 tracking-wide">
                            <li>
                                <a
                                    href="/#"
                                    aria-label="dashboard"
                                    class="relative flex items-center space-x-4 rounded-xl bg-gradient-to-r from-sky-600 to-cyan-400 px-3 py-2 text-white"
                                >
                                    <i class=" fas fa-th"></i>
                                </a>
                            </li>
                            ...
                            <li>
                                <a href="/#" class="group flex items-center space-x-4 rounded-md px-3 py-2 text-gray-600 justify-normal dark:text-gray-300 active" id="profile">
                                    <i class=" fas fa-user-circle"></i>
                                </a>
                            </li>

                            <li>
                                <a href="/#" class="group flex items-center space-x-4 rounded-md px-3 py-2 text-gray-600 justify-normal dark:text-gray-300" id="groups">
                                    <i class=" fas fa-layer-group"></i>
                                </a>
                            </li>

                            <li>
                                <a href="/#" class="group flex items-center space-x-4 rounded-md px-3 py-2 text-gray-600 justify-normal dark:text-gray-300" id="reports">
                                    <i class=" fas fa-flag"></i>
                                </a>
                            </li>

                            <li>
                                <a href="/#" class="group flex items-center space-x-4 rounded-md px-3 py-2 text-gray-600 justify-normal dark:text-gray-300" id="branches">
                                    <i class="fas fa-map-marked-alt "></i>
                                </a>
                            </li>

                            <li>
                                <a href="/#" class="group flex items-center space-x-4 rounded-md px-3 py-2 text-gray-600 justify-normal dark:text-gray-300" id="tests">
                                    <i class=" fas fa-flask"></i>
                                </a>
                            </li>

                            <li>
                                <a href="/#" class="group flex items-center space-x-4 rounded-md px-3 py-2 text-gray-600 justify-normal dark:text-gray-300" id="cultures">
                                    <i class=" fas fa-vial"></i>
                                </a>
                            </li>

                            <li>
                                <a href="/#" class="group flex items-center space-x-4 rounded-md px-3 py-2 text-gray-600 justify-normal dark:text-gray-300" id="culture_options">
                                    <i class=" fas fa-vial"></i>
                                </a>
                            </li>

                            <li>
                                <a href="/#" class="group flex items-center space-x-4 rounded-md px-3 py-2 text-gray-600 justify-normal dark:text-gray-300" id="antibiotics">
                                    <i class=" fas fa-capsules"></i>
                                </a>
                            </li>

                            <li>
                                <a href="/#" class="group flex items-center space-x-4 rounded-md px-3 py-2 text-gray-600 justify-normal dark:text-gray-300" id="doctors">
                                    <i class=" fa fa-user-md"></i>
                                </a>
                            </li>
                    ...
                    {user ?
                        <div class="-mx-6 flex items-center justify-between border-t px-6 pt-4 dark:border-gray-700" onClick={logout}>
                            <button class="group flex items-center rounded-md px-2 py-2 text-gray-600 dark:text-gray-300">
                                <svg
                                    xmlns="http://www.w3.org/2000/svg"
                                    class="h-6 w-6"
                                    fill="none"
                ...
                <div class={visible ? "ml-auto mb-6 lg:w-[75%] xl:w-[80%] 2xl:w-[85%] duration-300 ease-in" : "ml-auto mb-6 duration-300 ease-in lg:w-[85%] xl:w-[90%] 2xl:w-[95%]"}>
                    ...
                    <div class="px-6 pt-6 2xl:container">
                        <div class="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
                            ...
                            <div>
                                <div class="group p-6 sm:p-8 rounded-3xl bg-white border border-gray-200/50 dark:shadow-none dark:border-gray-700 dark:bg-gray-800 bg-opacity-50 shadow-2xl shadow-gray-600/10 lg:h-full">
                                    <svg
                                        class="m-auto w-40"
                                        viewBox="0 0 56 56"
                                        fill="none"
